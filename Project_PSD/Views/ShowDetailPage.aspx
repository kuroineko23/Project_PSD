...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>Show Name</td>
            <td><asp:Label Text="" ID="ShowNameLbl" runat="server" /></td>
        </tr>
        <tr>
            <td>Show Price</td>
            <td><asp:Label Text="" ID="ShowPriceLbl" runat="server" /></td>
        </tr>
        <tr>
            <td>Seller Name</td>
            <td><asp:Label Text="" ID="SellerNameLbl" runat="server" /></td>
        </tr>
        <tr>
            <td>Description</td>
            <td><asp:Label Text="" ID="DescriptionLbl" runat="server" /></td>
        </tr>
        <tr>
            <td>Average Rating</td>
            <td><asp:Label Text="" ID="AverageRatingLbl" runat="server" /></td>
        </tr>
        <tr>
            <td>Reviews</td>
            <td>
